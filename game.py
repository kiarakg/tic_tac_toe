...
class TicTacToe:
    ...
    def winner(self, square, letter):
        ...
        if square % 2 == 0:
            ...
            diagnonal1 = [self.board[i] for i in [0, 4, 8]]     # left to right diagonal
            if all([spot == letter for spot in diagnonal1]):
                return True

            diagnonal2 = [self.board[i] for i in [2, 4, 6]]     # right to left diagonal
            if all([spot == letter for spot in diagnonal2]):
                return True
